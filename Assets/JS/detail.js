...
<div class="detail-box">
    <div class="detail-content">
        ...
        <div class="meta-list">
            <div class="meta-item">
                <img src="./Assets/IMG/icons8-star-30.png" width="24" height="24" alt="RATING">
...
videoCard.innerHTML = `
<iframe width="500" height="294" src="https://www.youtube.com/embed/${key}?&theme=dark&color=white&rel=0" frameborder="0" allowFullscreen="1" title="${name}"
