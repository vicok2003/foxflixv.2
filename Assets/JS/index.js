...
//    Homepage sections (Top rated, upcoming, trending movies)
    ...
    const genreList = {
        ...
        // create genre string from genre
    ...
    for (const [index, movie] of movieList.entries()) {
        ...
        <div class="banner-content">
            ...
            <a href="./detail.html" class="btn" onclick="getMovieDetail(${id})">
                <img src="./Assets/IMG/icons8-circled-play-32.png" width="24" height="24" aria-hidden="true" alt="Play Circle">
